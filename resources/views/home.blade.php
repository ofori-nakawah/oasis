                    ...
                    <div class="card-body">
                        <div class="mt-4">
                            ...
                            <h4><b class="text-success">GHS</b> <br>
                                <b class="text-success">{{$dashboard_analytics["total_earnings"]}}</b>
                            </h4>
                ...
                <table class="appDataTable table table-striped table-responsive-sm dataTable no-footer">
                    ...
                    <tbody>
                        @if($dashboard_analytics["number_of_jobs"] <= 0)
                            <tr>
                            <td colspan="6">
                                <p class="text-center">You have no completed jobs at the moment</p>
                            </td>
                            </tr>
                            @else
                ...
                <table class="appDataTable table table-striped table-responsive-sm dataTable no-footer">
                    ...
                    <tbody>
                        @if($dashboard_analytics["number_of_activities"] <= 0)
                            <tr>
                            <td colspan="5">
                                <p class="text-center">You have no completed volunteer activities at the
                                    moment</p>
                            </td>
                            </tr>
                            @else
