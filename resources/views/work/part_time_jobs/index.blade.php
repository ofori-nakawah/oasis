            ...
            <div class="nk-block-des text-soft">
                ...
                <nav>
                    <ul class="breadcrumb breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="#">Available opportunities Near You</a></li>
                    </ul>
                </nav>
                </p>
            </div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="card card-bordered">
                <div class="card-header m-1" style="border-radius: 8px;">
                    <b>{{$post->title}}</b>
                    <div>
                        <small><em class="icon ni ni-clock"></em> Posted {{$post->createdOn}}</small>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mb-2">
                ...
                <div class="card-footer text-right bg-white" style="border-top: 1px solid #dbdfea;">
                    ...
                    <a href="{{route('user.show_fixed_term_job_details.show', ['uuid' => $post->id])}}"
