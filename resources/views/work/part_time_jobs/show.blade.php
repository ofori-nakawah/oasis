...
@section('header')
@component('components.listing-header', ['module' => 'Work', 'icon' => 'ni ni-briefcase', 'type' => 'Part Time Jobs', 'description' => 'Explore a world of endless opportunities around you'])@endcomponent
@endsection
