...
@section("content")
                ...
                <div class="nk-block-des text-soft">
                    ...
                    <nav>
                        <ul class="breadcrumb breadcrumb-arrow">
                            <li class="breadcrumb-item"><a href="#">Permanent or full time jobs</a></li>
                        </ul>
                    </nav>
                    </p>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{route('user.permanent_jobs.publish')}}" method="POST">
                {{csrf_field()}}
                <div class="">
                    <div class="mb-3">
                    ...
                    <div class="card-body1">
                        ...
                        <p><b>Employer Budget Range (Monthly)</b></p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group1 mb-3">
