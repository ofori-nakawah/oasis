...
<div class="row">
        ...
        <div class="col-md-6">
                <form action="{{route('p2p.submitQuoteRequest')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="">
                                <div class="mb-3">
                                        <h2><b>Request quote for P2P job</b></h2>
                                </div>
                                <input type="hidden" name="vorkers" value="{{ json_encode([['userId'=> $user->id]]) }}">
