...
@section("title") Edit outside VORK job experience @endsection
                ...
                <div class="nk-block-des text-soft">
                    ...
                    <nav>
                        <ul class="breadcrumb breadcrumb-arrow">
                            ...
                            <li class="breadcrumb-item">Edit outside vork job experience</li>
                        </ul>
                    </nav>
                    </p>
                </div>
        ...
        <div class="col-md-6">
            <form action="{{route('user.outsideVorkJobHistory.update', ["id" => $outsideVorkJob->id])}}" method="POST">
                ...
                <div class="input-group1 mb-3">
                    ...
                    <input type="text" class="form-control form-control-l @error('role') is-invalid @enderror" placeholder="Enter role title" name="role" value="{{ $outsideVorkJob->role }}">
                ...
                <div class="input-group1 mb-3">
                    ...
                    <input type="text" class="form-control form-control-l @error('employer') is-invalid @enderror" placeholder="Enter name of employer" name="employer" value="{{ $outsideVorkJob->employer }}">
