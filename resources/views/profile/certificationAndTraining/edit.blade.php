...
@section("title") Edit certification and training  @endsection
...
@section("content")
                ...
                <div class="nk-block-des text-soft">
                    ...
                    <nav>
                        <ul class="breadcrumb breadcrumb-arrow">
                            ...
                            <li class="breadcrumb-item">Edit certification and training </li>
                        </ul>
                    </nav>
                    </p>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{route('user.certificationAndTrainingHistory.update', ["id" => $certificationAndTraining->id])}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="mb-3">
                    <h2><b>Edit certification and training </b></h2>
                </div>
                ...
                <div class="input-group1 mb-3">
                    ...
                    <input type="number" class="form-control form-control-l @error('training_hours') is-invalid @enderror" placeholder="Enter training_hours" name="training_hours" value="{{ $certificationAndTraining->training_hours }}">
                ...
                <div class="text-right mb-3" id="publishBtn">
                    <button class="btn btn-success btn-l" type="button" onclick="confirmPublish()"><b>Update job certification and training </b></button>
                </div>
...
border: 1px solid rgba(255, 255, 255, 0.3);" id="publishConfirmationBox">
                    <h4>Are you sure?</h4>
                    <p>Confirm all the entered information above are accurate before proceeding to updating certification and training .</p>
                    <div class="text-right" >
                        <button class="btn btn-outline-secondary btn-l" type="button" onclick="cancelPublish()"><b>Cancel</b></button>
                        <button class="btn btn-success btn-l" type="submit"><b>Yes, update certification and training !</b></button>
                    </div>
                </div>
            </form>
