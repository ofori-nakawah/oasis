...
<style>
    ...
    li { margin: 0; padding: 0; line-height: 1.3; font-size: 11px; }
...
<div style="font-family: Rockwell, sans-serif; max-width: 800px; margin: 0 auto; padding: 10px; border-radius: 4px;">
        ...
        <tr style="width: 100%; ">
            ...
            <td>
                <span style="float: right; font-family: Rockwell !important; font-weight: normal;">
                    <div style="font-family: Rockwell !important; font-weight: normal; font-size: 11px;">Address: {{ $location }}</div>
                    <div style="font-family: Rockwell !important; font-weight: normal; font-size: 11px;">Tel: {{ $phoneNumber }}</div>
                    <div style="font-family: Rockwell !important; font-weight: normal; font-size: 11px;">Email: {{ $email }}</div>
                </span>
            </td>
        </tr>
    </table>
    ...
    <div style="margin-bottom: 10px;">
        ...
        <div style="font-family: Rockwell !important; font-weight: normal; line-height: 1.5; font-size: 10px;">
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">[{{ strtoupper(date("M Y", strtotime($educationHistory->start_date))) }} - {{ strtoupper($educationHistory->end_date ? date("M Y", strtotime($educationHistory->end_date)) : "Ongoing") }}]</div>
                </td>
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">[{{ strtoupper(date("M Y", strtotime($certificationsAndTraining->start_date))) }} - {{ strtoupper($certificationsAndTraining->end_date ? date("M Y", strtotime($certificationsAndTraining->end_date)) : "Ongoing") }}]</div>
                </td>
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">{{ strtoupper(date("M Y", strtotime($volunteer["date"]))) }}</div>
                </td>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">Expertise: ⭐ {{ $ratings["expertise"] }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">Work Ethic: ⭐ {{ $ratings["work_ethic"] }}</div>
                </td>
            </tr>
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">Professionalism: ⭐ {{ $ratings["professionalism"] }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">Customer Service: ⭐ {{ $ratings["customer_service"] }}</div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">{{ $reference['name'] }}</div>
                </td>
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">{{ $reference['company'] }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">{{ $reference['email'] }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell; font-weight: normal; font-size: 11px;">{{ $reference['phone_number'] }}</div>
                </td>
            </tr>
            @endforeach
        </table>
