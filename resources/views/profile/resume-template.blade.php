...
<div style="font-family: Rockwell, sans-serif; max-width: 800px; margin: 0 auto; padding: 10px; border-radius: 4px;">
    ...
    <div style="margin-top: 40px; margin-bottom: 40px">
        <div style="font-family: Rockwell;">An accomplished professional diversified experience in defining and delivering successful projects in the Software. I am highly analytical, versatile and a self-starter with proven ability to manage multiple projects while collaborating and supporting cross-functional teams</div>
    </div>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px; margin-top: -20px;">
            @foreach($outsideVorkJobs->sortByDesc("start_date") as $outsideVorkJob)
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important;">
                    <div style="margin-top: 20px; margin-bottom: 20px;">
                        <div>[{{ strtoupper(date("F Y", strtotime($outsideVorkJob->start_date))) }} - {{ strtoupper($outsideVorkJob->end_date ? date("F Y", strtotime($outsideVorkJob->end_date)) : "Ongoing") }}]</div>
                        <div style="font-weight: 800; font-family: Rockwell">{{ $outsideVorkJob->employer }}</div>
                    </div>
                </td>
                <td>
                    <div style="margin-top: 20px; margin-bottom: 20px;">
                        <div style="font-weight: bold; font-size: 18px; margin-bottom: 15px; font-family: Rockwell">{{ $outsideVorkJob->role }}</div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell">[{{ strtoupper(date("F Y", strtotime($educationHistory->start_date))) }} - {{ strtoupper($educationHistory->end_date ? date("F Y", strtotime($educationHistory->end_date)) : "Ongoing") }}]</div>
                </td>
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell">{{ $educationHistory->programme }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell">{{ $educationHistory->institution }}</div>
                </td>
            </tr>
            @endforeach
        </table>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell">[{{ strtoupper(date("F Y", strtotime($certificationsAndTraining->start_date))) }} - {{ strtoupper($certificationsAndTraining->end_date ? date("F Y", strtotime($certificationsAndTraining->end_date)) : "Ongoing") }}]</div>
                </td>
                <td style="width: 35%; vertical-align: top !important; margin-bottom: 20px;">
                    <div style="font-family: Rockwell">{{ $certificationsAndTraining->programme }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell">{{ $certificationsAndTraining->institution }}</div>
                </td>
            </tr>
            @endforeach
        </table>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                ...
                <td>
                    <div style="font-family: Rockwell">{{ $volunteer["volunteer_hours_awarded"] }}</div>
                </td>
            </tr>
            @endforeach
        </table>
    ...
    <div>
        ...
        <table style="width: 100%; border-bottom-width: 0px;">
            ...
            <tr style="width: 100%;">
                ...
                <td>
                    <div style="font-family: Rockwell">{{ $reference['email'] }}</div>
                </td>
                <td>
                    <div style="font-family: Rockwell">{{ $reference['phone_number'] }}</div>
                </td>
            </tr>
            @endforeach
        </table>
