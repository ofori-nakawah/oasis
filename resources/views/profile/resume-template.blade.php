            ...
            <tr style="width: 100%;">
                <td style="width: 35%; vertical-align: top !important; padding: 0;">
                    <div style="margin-top: 10px; margin-bottom: 5px;">
                        <div style="font-size: 14px;">[{{ strtoupper(date("M Y", strtotime($outsideVorkJob->start_date))) }} - {{ strtoupper($outsideVorkJob->end_date ? date("M Y", strtotime($outsideVorkJob->end_date)) : "Ongoing") }}]</div>
