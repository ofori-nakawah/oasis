    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{route('user.volunteerism.publish')}}" method="POST">
                ...
                <div class="">
                    <div class="mb-3">
                        <h2><b>Update your project</b></h2>
                    </div>
                    <div class="card-body1">
                        <div class="input-group1 mb-3">
{{--                            <label for="name"><b>Activity Name</b></label>--}}
                            <input type="text" value="{{$post->name}}" class="form-control form-control-l @error('name') is-invalid @enderror" placeholder="Enter name of activity or project" name="name">
...
{{--                            <label for="description"><b>Description</b></label>--}}
                            <textarea class="form-control form-control-l @error('description') is-invalid @enderror" placeholder="Enter brief description of the project" name="description">{{$post->description}}</textarea>
...
{{--                                    <label for="time"><b>Time</b></label>--}}
                                    <input type="time" class="form-control form-control-l @error('time') is-invalid @enderror" placeholder="Select time of activity" name="time" value="{{$post->time}}">
...
{{--                                    <label for="number_of_participants"><b>Number of Participants</b></label>--}}
                                    <input type="number" class="form-control form-control-l @error('maximum_number_of_volunteers') is-invalid @enderror" placeholder="Specify number of participants" name="maximum_number_of_volunteers" value="{{$post->maximum_number_of_volunteers}}">
...
{{--                                    <label for="name"><b>Volunteer Hours</b></label>--}}
                                    <input type="number" class="form-control form-control-l @error('volunteer_hours') is-invalid @enderror" placeholder="Specify volunteer hours" name="volunteer_hours" value="{{$post->volunteer_hours}}">
...
{{--                            <label for="name"><b>Location</b></label>--}}
                            <input type="text" value="{{$post->location}}" class="form-control form-control-l @error('location') is-invalid @enderror" placeholder="Provide location of activity" readonly id="location" name="location" data-toggle="modal" data-target="#locationModal">
                            <input type="hidden" value="{{$post->location}}" name="location" id="onboardingLocationName">
...
{{--                            <label for="other_relevant_information"><b>Other Relevant Information</b></label>--}}
                            <textarea type="tel" class="form-control form-control-l @error('other_relevant_information') is-invalid @enderror" placeholder="Specify any other relevant information" name="other_relevant_information" >{{$post->other_relevant_information}}</textarea>
